...
parser.add_argument('--data_path',default=os.getcwd()+r'/filelist/cub', type=str)
...
parser.add_argument('--model_path', default=os.getcwd()+r'/checkpoints/cub/ResNet12_meta_deepbdc_5way_5shot_metatrain/best_model.tar', help='meta-trained or pre-trained model .tar file path')
...
for _ in range(params.test_task_nums):
    ...
    for _, (x, y) in enumerate(tqdm_gen):
        with torch.no_grad():
            print(x)
